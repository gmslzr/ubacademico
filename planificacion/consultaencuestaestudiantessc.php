    ...
    $(document).ready(function(){
        ...
        $("#cedula_doc").blur(function(){
            ...
            var busqueda = "cod_mat";
                $.ajax({
                    type: "GET",
                    url: "lib/procesamiento.php?dato="+cedula_doc+"&busqueda="+busqueda+"&cond=cedula&tabla=encuesta_estudiantes_sc&multiple=materia",
                    cache: false,
                    success: function(html)
                    {
                        $("#materia").html(html);
        ...
        $("#materia").change(function(){
         ...
         $("#materia").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "lib/procesamiento.php?dato="+materia+"&busqueda="+busqueda+"&cond=cod_mat&tabla=encuesta_estudiantes_sc&multiple=lapso_cons&cedula="+cedula_doc+"",
                cache: false,
                success: function(html)
                {
        ...
        $("#lapso_cons").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "lib/procesamiento.php?dato="+lapso_cons+"&busqueda="+busqueda+"&cond=lapso&tabla=encuesta_estudiantes_sc&multiple=seccion&cod_mat="+materia+"&cedula="+cedula_doc+"",
                cache: false,
                success: function(html)
                {
                   $("#seccion").html(html);
            ...
            <div class="columna_central">
                <div>
                    <form name="ConsultaEncuestaEstudiantesSC" action="promedioencuestaestudiantessctopdf.php" method="post" target="_blank">
