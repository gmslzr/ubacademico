    ...
    $(document).ready(function(){
        ...
        $("#cedula_doc").blur(function(){
            ...
            var busqueda = "cod_mat";
                $.ajax({
                    type: "GET",
                    url: "lib/procesamiento.php?dato="+cedula_doc+"&busqueda="+busqueda+"&cond=cedula&tabla=evaluacion_docente&multiple=materia",
                    cache: false,
                    success: function(html)
                    {
                        $("#materia").html(html);
        ...
        $("#materia").change(function(){
         ...
         $("#materia").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "lib/procesamiento.php?dato="+materia+"&busqueda="+busqueda+"&cond=cod_mat&tabla=evaluacion_docente&multiple=lapso_cons&cedula="+cedula_doc+"",
                cache: false,
                success: function(html)
                {
        ...
        $("#lapso_cons").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "lib/procesamiento.php?dato="+lapso_cons+"&busqueda="+busqueda+"&cond=lapso&tabla=evaluacion_docente&multiple=seccion&cod_mat="+materia+"&cedula="+cedula_doc+"",
                cache: false,
                success: function(html)
                {
                   $("#seccion").html(html);
            ...
            <div class="columna_central">
                    <form name="ConsultaEvaluacionDocente" action="promedioevaluaciondocentetopdf.php" method="post" target="_blank">
                        <h2 align="center">Supervisi&oacute;n del Desempe&ntilde;o Docente por el Coordinador de C&aacute;tedra</h2>  
                            <table align="center">
