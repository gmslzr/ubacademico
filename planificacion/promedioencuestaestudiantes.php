      ...
      <form name="PromedioEncuestaEstudiantes" method="post" align="center">
        ...
        <table class="lista" width="100%" align="center">
          <tr style='font-size:13px; background-color:#C2C2C2;'>
              ...
              <td>1</td>
              <td align="left">Es Puntual en la llegada al aula o sitio de desarrollo de la clase</td>
              ...
              <td>2</td>
              <td align="left">Cumple con la hora de salida seg&uacute;n el horario de clases</td>
              ...
              <td>3</td>
              <td align="left">Cumple con las actividades acad&eacute;micas seg&uacute;n el horario establecido</td>
              ...
              <td>4</td>
              <td align="left">Desarrolla el contenido program&aacute;tico con lenguaje claro y preciso</td>
              ...
              <td>5</td>
              <td align="left">Emplea diversas t&eacute;cnicas de aprendizaje para desarrollar el contenido planificado</td>
              ...
              <td>6</td>
              <td align="left">Usa t&eacute;cnicas para propiciar la participaci&oacute;n de los estudiantes</td>
              ...
              <td>7</td>
              <td align="left">Posee habilidades en el manejo de los recursos did&aacute;cticos</td>
              ...
              <td>9</td>
              <td align="left">Demuestra conocimiento y dominio sobre el contenido de la asignatura</td>
              ...
              <td>10</td>
              <td align="left">Responde, atiende y aclara dudas e interrogantes</td>
              ...
              <td>11</td>
              <td align="left">Cumple con lo establecido en el Plan de Evaluaci&oacute;n</td>
              ...
              <td>12</td>
              <td align="left">Usa diferentes t&eacute;cnicas o estrategias para evaluar el aprendizaje</td>
              ...
              <td>13</td>
              <td align="left">Retroinformaci&oacute;n despu&eacute;s de corregida cada estrategia de evaluaci&oacute;n</td>
              ...
              <td>14</td>
              <td align="left">Efect&uacute;a la entrega de los soportes desp&uacute;es de corregidas las estrategias de evaluaci&oacute;n</td>
              ...
              <td>15</td>
              <td align="left">Sugiere actividades de investigaci&oacute;n para desarrollo de clases futuras</td>
              ...
              <td>16</td>
              <td align="left">Registra la asistencia de los estudios</td>
              <td><?php echo truncateFloat($fila_resultado['prom16'],2); ?></td>
              <td><?php
                                                if ($fila_resultado['prom16']>4.50) {
                                                    echo "Muy Bueno";
                                                } elseif ($fila_resultado['prom16'] <=4.50 && $fila_resultado['prom16']>=4) {
                                                    echo "Bueno";
                                                } elseif ($fila_resultado['prom16'] <4 && $fila_resultado['prom16']>=3) {
                                                    echo "Regular";  
                                                } elseif ($fila_resultado['prom16'] <3 && $fila_resultado['prom16']>=2) {
                                                    echo "Deficiente"; 
                                                } else {
                                                    echo "Muy Deficiente";
                                                }
              ...
              <td>17</td>
              <td align="left">Controla la disciplina del grupo</td>
              <td><?php echo truncateFloat($fila_resultado['prom17'],2); ?></td>
              <td><?php
                                                if ($fila_resultado['prom17']>4.50) {
                                                    echo "Muy Bueno";
                                                } elseif ($fila_resultado['prom17'] <=4.50 && $fila_resultado['prom17']>=4) {
                                                    echo "Bueno";
                                                } elseif ($fila_resultado['prom17'] <4 && $fila_resultado['prom17']>=3) {
                                                    echo "Regular";  
                                                } elseif ($fila_resultado['prom17'] <3 && $fila_resultado['prom17']>=2) {
                                                    echo "Deficiente"; 
                                                } else {
                                                    echo "Muy Deficiente";
                                                }
              ...
              <td>18</td>
              <td align="left">Su presentaci&oacute;n personal est&aacute; acorde con el rol de facilitador</td>
              <td><?php echo truncateFloat($fila_resultado['prom18'],2); ?></td>
              <td><?php
                                                if ($fila_resultado['prom18']>4.50) {
                                                    echo "Muy Bueno";
                                                } elseif ($fila_resultado['prom18'] <=4.50 && $fila_resultado['prom18']>=4) {
                                                    echo "Bueno";
                                                } elseif ($fila_resultado['prom18'] <4 && $fila_resultado['prom18']>=3) {
                                                    echo "Regular";  
                                                } elseif ($fila_resultado['prom18'] <3 && $fila_resultado['prom18']>=2) {
                                                    echo "Deficiente"; 
                                                } else {
                                                    echo "Muy Deficiente";
                                                }
              ...
              <td>19</td>
              <td align="left">El trato es respetuoso con los estudiantes</td>
              <td><?php echo truncateFloat($fila_resultado['prom19'],2); ?></td>
              <td><?php
                                                if ($fila_resultado['prom19']>4.50) {
                                                    echo "Muy Bueno";
                                                } elseif ($fila_resultado['prom19'] <=4.50 && $fila_resultado['prom19']>=4) {
                                                    echo "Bueno";
                                                } elseif ($fila_resultado['prom19'] <4 && $fila_resultado['prom19']>=3) {
                                                    echo "Regular";  
                                                } elseif ($fila_resultado['prom19'] <3 && $fila_resultado['prom19']>=2) {
                                                    echo "Deficiente"; 
                                                } else {
                                                    echo "Muy Deficiente";
                                                }
              ...
              <td>20</td>
              <td align="left">Ejecuta la retroinformaci&oacute;n del corte seg&uacute;n lo establecido en el plan de evaluaci&oacute;n</td>
              <td><?php echo truncateFloat($fila_resultado['prom20'],2); ?></td>
              <td><?php
                                                if ($fila_resultado['prom20']>4.50) {
                                                    echo "Muy Bueno";
                                                } elseif ($fila_resultado['prom20'] <=4.50 && $fila_resultado['prom20']>=4) {
                                                    echo "Bueno";
                                                } elseif ($fila_resultado['prom20'] <4 && $fila_resultado['prom20']>=3) {
                                                    echo "Regular";  
                                                } elseif ($fila_resultado['prom20'] <3 && $fila_resultado['prom20']>=2) {
                                                    echo "Deficiente"; 
                                                } else {
                                                    echo "Muy Deficiente";
                                                }
