...
?>
			<div class="columna_central">
				...
				<a href="<?php echo 'modificarplanevaluacion.php?cod_mat='.$cod_mat.'&sec_mat='.$sec_mat.'&cod_nuc_mat='.$cod_nuc_mat;?>">Modificar Plan Evaluaci&oacute;n</a><br />
					...
					for($a=1;$a<=$numcortes['numcortes'];$a++)
					{
						...
						if(isset($cod_mat) && !empty($cod_mat) && isset($sec_mat) && !empty($sec_mat) && isset($cod_nuc_mat) && ($cod_nuc_mat)!="")
						{
							...
							if ($cant>0)
							{
						 	...
						 	{
								echo '<tr><td  class=td-a colspan="4">No se encontraron evaluaciones para este corte</td></tr>';
						 	}
						}
						echo '</table>';
					}
